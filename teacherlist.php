  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Teacher Tables</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Teacher</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">View Teacher</a></li>
...
$i=1;
 ...
 <td><?php echo $row->staff_depart;?></td>  
