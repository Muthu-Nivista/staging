  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Marks Report</h4>
		    <ol class="breadcrumb">
  <li class="breadcrumb-item active" aria-current="page">Academic</li>
            <li class="breadcrumb-item"><a href="javaScript:void();">View Marks</a></li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="signupForm" action="<?php  echo base_url()."admin/show_marklist";?>" method="post">
...
$.ajax({
   type:'POST',
   url:"<?php echo base_url(); ?>admin/show_marklist/",
