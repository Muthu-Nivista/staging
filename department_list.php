  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Department Info</h4>
		    <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>Department Details </div>
            <div class="card-body">
...
<td><?php echo $i;?></td>  
 ...
 <td><a href="<?php echo base_url();?>admin/edit_user?id=<?php echo $row->designation;?>">Edit</a>&emsp;
<a href="<?php echo base_url();?>admin/delete_user?id=<?php echo $row->designation;?>">Delete</a></td>
            </tr>  
         <?php 
